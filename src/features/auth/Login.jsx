...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#06080e] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-radial-gradient from-instagram-pink/10 via-transparent to-transparent pointer-events-none" />
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 relative overflow-hidden shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="h-12 w-12 rounded-2xl bg-gradient-to-tr from-instagram-orange via-instagram-pink to-instagram-purple flex items-center justify-center shadow-lg shadow-instagram-pink/20 mb-4 animate-bounce">
            <Instagram size={24} className="text-white" />
          </div>
          <h2 className="text-2xl font-black tracking-tight text-white mb-1">Welcome Back</h2>
          <p className="text-gray-400 text-sm">Manage your Instagram content effortlessly</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to="/register" className="text-instagram-pink font-semibold hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
